...
function Footer() {
  return (
    ...
    <div className='col-md-6 col-lg-4 col-12 ft-3'>
        <h3>Contact Info</h3>
        <p><i className="fa-solid fa-phone"></i> 0345 5258766</p>
        <p><i className="fa-solid fa-envelope"></i> charslan.0000@gmail.com</p>
        <p><i className="fa-solid fa-paper-plane"></i> Imperial Rent a Car, Shah Wali Colony, Wah Cantt, Rawalpindi</p>
        </div> 
     </div>
    </div>
    </div>
